  ...
  return (
    <Container>
      <div>
        ...
        <Box>
          <span>Iniciado como um projeto pelo seus idealizadores, Julio Sena e Silverio Vale no final do mês de Outubro de 2020, a intenção era de ser um chat de troca de informações sobre assuntos abordados dentro do mundo React, como: melhores práticas, ferramentas, etc.
        ...
        */}
        ...
        <span>O projeto é moderado pelo Silvério Vale e Julio Sena, porém qualquer um é livre para discordar e expor sua opinião. Qualquer um pode dar inicio a discussão e se for de interesse fazer até mesmo um hands-on ou uma aprensentação.
              As reuniões tem sido gravadas e estão disponíveis no (dtiflix - Colocar o link aqui)</span>
      </div>
    </Container>
  )
}
